...
public class OrderDB extends SQLiteOpenHelper{
    ...
    interface References{
        ...
        String ID_SALARY = String.format("REDERENCES %s(%s)" +
                                " ON DELATE CASCADE",
                        Tables.SALARY,OrderContract.Salarys.ID);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(String.format("CREATE TABLE %s(%s INTEGER PRIMARY KEY AUTOINCREMENT," +
                ...
                OrderContract.Salarys.EMP_NO,
                OrderContract.Salarys.SALARY,
                OrderContract.Salarys.FROMDATE));
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE ID EXISTS "+Tables.SALARY);
        onCreate(db);
