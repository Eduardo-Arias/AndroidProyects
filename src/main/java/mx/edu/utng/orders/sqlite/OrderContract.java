...
public class OrderContract {
    ...
    public static class Salarys implements SalaryColumns{
        public static String generateIdSalary(){
            return  "SA-"+ UUID.randomUUID().toString();
        }
    }
    //------------------------------------------
